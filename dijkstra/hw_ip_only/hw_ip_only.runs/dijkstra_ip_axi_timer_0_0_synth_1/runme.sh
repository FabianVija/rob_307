...
HD_PWD='/home/lais/Documents/ROB307/rob_307/dijkstra/hw_ip_only/hw_ip_only.runs/dijkstra_ip_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dijkstra_ip_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dijkstra_ip_axi_timer_0_0.tcl
