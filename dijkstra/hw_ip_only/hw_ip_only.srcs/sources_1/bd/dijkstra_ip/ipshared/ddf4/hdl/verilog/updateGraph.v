...
input  [31:0] size;
output  [8:0] graph_address0;
output   graph_ce0;
output   graph_we0;
output  [31:0] graph_d0;
...
wire   [30:0] i_2_fu_111_p2;
reg    ap_block_state2;
reg   [30:0] i_reg_91;
wire   [63:0] tmp_7_fu_122_p1;
...
assign graph_address0 = tmp_7_fu_122_p1;

assign graph_d0 = inStream_TDATA;

assign i_2_fu_111_p2 = (i_reg_91 + 31'd1);

assign i_cast_fu_102_p1 = i_reg_91;

assign tmp_7_fu_122_p1 = i_reg_91;

assign tmp_fu_106_p2 = (($signed(i_cast_fu_102_p1) < $signed(size)) ? 1'b1 : 1'b0);

endmodule //updateGraph
