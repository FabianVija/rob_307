...
architecture rtl of dijkstra_Dset_ram is 
...
architecture arch of dijkstra_Dset is
    component dijkstra_Dset_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    dijkstra_Dset_ram_U :  component dijkstra_Dset_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
