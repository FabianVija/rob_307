...
entity dijkstra_CTRL_BUS_s_axi is
generic (
...
architecture behave of dijkstra_CTRL_BUS_s_axi is
    ...
    constant ADDR_FLAG_DATA_0 : INTEGER := 16#18#;
    constant ADDR_FLAG_CTRL   : INTEGER := 16#1c#;
