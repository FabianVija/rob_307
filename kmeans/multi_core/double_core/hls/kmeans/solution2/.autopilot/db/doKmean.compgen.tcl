...
set out_width 11
set exp i0*i1
set arg_lists {i0 {7 0 +} i1 {11 1 +} p {11 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {7 0 +} i1 {11 1 +} m {11 1 +} i2 {3 0 +} p {11 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {7 0 +} i1 {11 1 +} m {11 1 +} i2 {4 0 +} p {11 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {7 0 +} i1 {11 1 +} m {11 1 +} i2 {5 0 +} p {11 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {7 0 +} i1 {11 1 +} m {11 1 +} i2 {6 0 +} p {11 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set out_width 11
set exp i0*i1+i2
set arg_lists {i0 {7 0 +} i1 {11 1 +} m {11 1 +} i2 {7 0 +} p {11 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set ID 73
set hasByteEnable 0
set MemName doKmean_np_cluster
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 32
set AddrRange 20
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 74 \
			corename doKmean_CRTL_BUS_axilite \
			name doKmean_CRTL_BUS_s_axi \
			ports {$port_CRTL_BUS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler doKmean_CRTL_BUS_s_axi
}
