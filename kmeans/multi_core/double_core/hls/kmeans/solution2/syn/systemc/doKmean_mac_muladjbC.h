...
#ifndef __doKmean_mac_muladjbC__HH__
#define __doKmean_mac_muladjbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mac_muladjbC) {
    ...
    SC_CTOR(doKmean_mac_muladjbC):  simcore_mac_0_U ("simcore_mac_0_U") {
