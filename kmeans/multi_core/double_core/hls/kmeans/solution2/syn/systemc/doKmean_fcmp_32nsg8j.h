...
#ifndef __doKmean_fcmp_32nsg8j__HH__
#define __doKmean_fcmp_32nsg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_fcmp_32nsg8j) {
    ...
    SC_CTOR(doKmean_fcmp_32nsg8j):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
