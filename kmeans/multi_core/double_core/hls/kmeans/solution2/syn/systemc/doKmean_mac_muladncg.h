...
#ifndef __doKmean_mac_muladncg__HH__
#define __doKmean_mac_muladncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mac_muladncg) {
    ...
    SC_CTOR(doKmean_mac_muladncg):  simcore_mac_4_U ("simcore_mac_4_U") {
