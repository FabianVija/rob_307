...
#ifndef __doKmean_fsqrt_32nhbi__HH__
#define __doKmean_fsqrt_32nhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_fsqrt_32nhbi) {
    ...
    SC_CTOR(doKmean_fsqrt_32nhbi):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
