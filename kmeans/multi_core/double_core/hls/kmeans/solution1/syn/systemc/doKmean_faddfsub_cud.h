...
#ifndef __doKmean_faddfsub_cud__HH__
#define __doKmean_faddfsub_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_faddfsub_cud) {
    ...
    SC_CTOR(doKmean_faddfsub_cud):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
