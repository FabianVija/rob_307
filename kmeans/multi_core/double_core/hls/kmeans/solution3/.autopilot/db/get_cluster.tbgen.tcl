...
set C_modelArgList {
	{ data_set float 32 regular {array 25000 { 1 1 } 1 1 }  }
	{ data_set_offset int 9 regular  }
	{ centroids float 32 regular {array 1000 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data_set", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "data_set_offset", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "data_set_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "data_set", "role": "address0" }} , 
 	...
 	{ "name": "data_set_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "data_set", "role": "address1" }} , 
 	...
 	{ "name": "data_set_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "data_set_offset", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.doKmean_fmul_32nsdEe_U4", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.doKmean_fcmp_32nseOg_U5", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.doKmean_fsqrt_32nfYi_U6", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	data_set { ap_memory {  { data_set_address0 mem_address 1 15 }  { data_set_ce0 mem_ce 1 1 }  { data_set_q0 mem_dout 0 32 }  { data_set_address1 mem_address 1 15 }  { data_set_ce1 mem_ce 1 1 }  { data_set_q1 mem_dout 0 32 } } }
	data_set_offset { ap_none {  { data_set_offset in_data 0 9 } } }
