...
#ifndef __doKmean_fsqrt_32nfYi__HH__
#define __doKmean_fsqrt_32nfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_fsqrt_32nfYi) {
    ...
    SC_CTOR(doKmean_fsqrt_32nfYi):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
