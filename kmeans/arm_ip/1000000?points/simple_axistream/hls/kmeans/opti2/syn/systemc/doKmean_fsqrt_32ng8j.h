...
#ifndef __doKmean_fsqrt_32ng8j__HH__
#define __doKmean_fsqrt_32ng8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_fsqrt_32ng8j) {
    ...
    SC_CTOR(doKmean_fsqrt_32ng8j):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
