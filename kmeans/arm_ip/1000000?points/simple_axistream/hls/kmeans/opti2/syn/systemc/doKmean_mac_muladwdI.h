...
#ifndef __doKmean_mac_muladwdI__HH__
#define __doKmean_mac_muladwdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mac_muladwdI) {
    ...
    SC_CTOR(doKmean_mac_muladwdI):  simcore_mac_0_U ("simcore_mac_0_U") {
