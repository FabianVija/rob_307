...
#ifndef __doKmean_mac_muladxdS__HH__
#define __doKmean_mac_muladxdS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mac_muladxdS) {
    ...
    SC_CTOR(doKmean_mac_muladxdS):  simcore_mac_1_U ("simcore_mac_1_U") {
