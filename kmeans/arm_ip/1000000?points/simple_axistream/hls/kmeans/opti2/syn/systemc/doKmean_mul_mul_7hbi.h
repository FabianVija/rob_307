...
#ifndef __doKmean_mul_mul_7hbi__HH__
#define __doKmean_mul_mul_7hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mul_mul_7hbi) {
    ...
    SC_CTOR(doKmean_mul_mul_7hbi):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
