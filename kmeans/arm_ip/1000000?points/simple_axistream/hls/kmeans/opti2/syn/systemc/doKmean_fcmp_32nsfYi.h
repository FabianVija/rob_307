...
#ifndef __doKmean_fcmp_32nsfYi__HH__
#define __doKmean_fcmp_32nsfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_fcmp_32nsfYi) {
    ...
    SC_CTOR(doKmean_fcmp_32nsfYi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
