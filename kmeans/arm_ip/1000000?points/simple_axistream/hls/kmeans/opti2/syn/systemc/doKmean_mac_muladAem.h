...
#ifndef __doKmean_mac_muladAem__HH__
#define __doKmean_mac_muladAem__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mac_muladAem) {
    ...
    SC_CTOR(doKmean_mac_muladAem):  simcore_mac_4_U ("simcore_mac_4_U") {
