...
#ifndef __doKmean_sitofp_32udo__HH__
#define __doKmean_sitofp_32udo__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_sitofp_32udo) {
    ...
    SC_CTOR(doKmean_sitofp_32udo):  ACMP_sitofp_U ("ACMP_sitofp_U") {
