...
#ifndef __doKmean_mul_mul_7vdy__HH__
#define __doKmean_mul_mul_7vdy__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mul_mul_7vdy) {
    ...
    SC_CTOR(doKmean_mul_mul_7vdy):  ACMP_smul_us_U ("ACMP_smul_us_U") {
