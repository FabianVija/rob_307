...
#ifndef __doKmean_mac_muladpcA__HH__
#define __doKmean_mac_muladpcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mac_muladpcA) {
    ...
    SC_CTOR(doKmean_mac_muladpcA):  simcore_mac_4_U ("simcore_mac_4_U") {
