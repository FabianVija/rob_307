...
#ifndef __doKmean_mac_muladocq__HH__
#define __doKmean_mac_muladocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mac_muladocq) {
    ...
    SC_CTOR(doKmean_mac_muladocq):  simcore_mac_3_U ("simcore_mac_3_U") {
