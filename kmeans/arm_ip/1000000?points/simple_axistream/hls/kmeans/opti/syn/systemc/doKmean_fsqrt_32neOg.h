...
#ifndef __doKmean_fsqrt_32neOg__HH__
#define __doKmean_fsqrt_32neOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_fsqrt_32neOg) {
    ...
    SC_CTOR(doKmean_fsqrt_32neOg):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
