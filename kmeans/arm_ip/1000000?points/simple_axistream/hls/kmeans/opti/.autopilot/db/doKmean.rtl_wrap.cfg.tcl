...
set structArgument3 [list 32 2 5 6 ]
set NameSpace3 [list ]
set structIsPacked3 "0"
set DataType3 [list "ap_axis<32, 2, 5, 6>" "struct ap_axis" $structMem3 0 0 $structParameter3 $structArgument3 $NameSpace3 $structIsPacked3]
...
set PortName5 "points"
set BitWidth5 "1600000"
set ArrayOpt5 ""
set Const5 "0"
set Volatile5 "1"
set Pointer5 "0"
