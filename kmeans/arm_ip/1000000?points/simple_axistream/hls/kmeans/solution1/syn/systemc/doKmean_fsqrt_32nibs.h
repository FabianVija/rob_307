...
#ifndef __doKmean_fsqrt_32nibs__HH__
#define __doKmean_fsqrt_32nibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_fsqrt_32nibs) {
    ...
    SC_CTOR(doKmean_fsqrt_32nibs):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
