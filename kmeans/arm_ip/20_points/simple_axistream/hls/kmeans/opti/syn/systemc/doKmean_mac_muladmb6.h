...
#ifndef __doKmean_mac_muladmb6__HH__
#define __doKmean_mac_muladmb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mac_muladmb6) {
    ...
    SC_CTOR(doKmean_mac_muladmb6):  simcore_mac_2_U ("simcore_mac_2_U") {
