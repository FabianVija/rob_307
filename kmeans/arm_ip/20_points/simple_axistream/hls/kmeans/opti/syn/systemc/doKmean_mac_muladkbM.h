...
#ifndef __doKmean_mac_muladkbM__HH__
#define __doKmean_mac_muladkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(doKmean_mac_muladkbM) {
    ...
    SC_CTOR(doKmean_mac_muladkbM):  simcore_mac_0_U ("simcore_mac_0_U") {
