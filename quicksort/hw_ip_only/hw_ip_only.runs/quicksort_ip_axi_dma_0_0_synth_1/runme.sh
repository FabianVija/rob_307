...
HD_PWD='/home/lais/Documents/ROB307/rob_307/quicksort/hw_ip_only/hw_ip_only.runs/quicksort_ip_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log quicksort_ip_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source quicksort_ip_axi_dma_0_0.tcl
