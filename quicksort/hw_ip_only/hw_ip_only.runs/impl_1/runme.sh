...
HD_PWD='/home/lais/Documents/ROB307/rob_307/quicksort/hw_ip_only/hw_ip_only.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log quicksort_ip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source quicksort_ip_wrapper.tcl -notrace
