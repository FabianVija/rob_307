...
HD_PWD='/home/lais/Documentos/ROB307/rob_307/quicksort/hw_one_ip/hw_one_ip.runs/hw_one_ip_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_one_ip_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hw_one_ip_axi_smc_0.tcl
