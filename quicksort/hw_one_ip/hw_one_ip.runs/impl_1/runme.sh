...
HD_PWD='/home/lais/Documentos/ROB307/rob_307/quicksort/hw_one_ip/hw_one_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hw_one_ip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hw_one_ip_wrapper.tcl -notrace
