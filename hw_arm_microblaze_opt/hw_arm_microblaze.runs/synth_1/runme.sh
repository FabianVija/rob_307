...
HD_PWD='/home/lais/Documentos/ROB307/rob_307/hw_arm_microblaze_opt/hw_arm_microblaze.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_arm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_arm_wrapper.tcl
