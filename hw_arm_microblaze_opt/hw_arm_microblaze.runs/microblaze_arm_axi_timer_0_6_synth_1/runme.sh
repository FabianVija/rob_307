...
HD_PWD='/home/lais/Documentos/ROB307/rob_307/hw_arm_microblaze/hw_arm_microblaze.runs/microblaze_arm_axi_timer_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_arm_axi_timer_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_arm_axi_timer_0_6.tcl
