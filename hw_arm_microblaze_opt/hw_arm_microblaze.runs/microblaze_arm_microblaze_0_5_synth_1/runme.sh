...
HD_PWD='/home/lais/Documentos/ROB307/rob_307/hw_arm_microblaze_opt/hw_arm_microblaze.runs/microblaze_arm_microblaze_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_arm_microblaze_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_arm_microblaze_0_5.tcl
