...
(* CORE_GENERATION_INFO="Count,hls_ip_2018_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.451000,HLS_SYN_LAT=3,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=541,HLS_SYN_LUT=906,HLS_VERSION=2018_2}" *)
...
reg   [0:0] exitcond_reg_309;
reg    outStream_TDATA_blk_n;
wire    ap_CS_fsm_state4;
wire    ap_CS_fsm_state5;
reg   [5:0] valOut_dest_V_reg_139;
reg   [4:0] valOut_id_V_reg_152;
reg   [0:0] valOut_last_V_reg_165;
reg   [1:0] valOut_user_V_reg_178;
reg   [3:0] valOut_strb_V_reg_191;
reg   [3:0] valOut_keep_V_reg_204;
reg   [31:0] tmp_data_V_reg_217;
reg   [31:0] i_reg_230;
reg   [31:0] filter_read_reg_299;
reg   [31:0] size_read_reg_304;
wire   [0:0] exitcond_fu_241_p2;
wire    ap_block_state2_pp0_stage0_iter0;
reg    ap_block_state3_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [31:0] i_1_fu_246_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [31:0] p_s_fu_291_p3;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg    ap_block_state5;
wire   [0:0] tmp_7_fu_280_p2;
wire   [31:0] count_fu_285_p2;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
Count_CTRL_BUS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_CTRL_BUS_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_CTRL_BUS_DATA_WIDTH ))
Count_CTRL_BUS_s_axi_U(
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_fu_241_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond_reg_309 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_data_V_reg_217 <= p_s_fu_291_p3;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        tmp_data_V_reg_217 <= 32'd0;
    end
end
...
always @ (*) begin
    if ((exitcond_fu_241_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_reg_309 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((outStream_V_data_V_1_ack_in == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_241_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_241_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond_reg_309 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond_reg_309 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state2_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = ((exitcond_reg_309 == 1'd0) & (inStream_V_data_V_0_vld_out == 1'b0));
end
...
assign count_fu_285_p2 = (tmp_data_V_reg_217 + 32'd1);

assign exitcond_fu_241_p2 = ((i_reg_230 == size_read_reg_304) ? 1'b1 : 1'b0);

assign i_1_fu_246_p2 = (i_reg_230 + 32'd1);
...
assign p_s_fu_291_p3 = ((tmp_7_fu_280_p2[0:0] === 1'b1) ? count_fu_285_p2 : tmp_data_V_reg_217);

assign tmp_7_fu_280_p2 = ((inStream_V_data_V_0_data_out == filter_read_reg_299) ? 1'b1 : 1'b0);
