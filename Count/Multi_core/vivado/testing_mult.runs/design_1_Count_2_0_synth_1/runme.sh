...
HD_PWD='/home/fabian/Documents/ensta/deuxieme/rob307/multicore/count/vivado/testing_mult.runs/design_1_Count_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Count_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Count_2_0.tcl
