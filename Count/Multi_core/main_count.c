...
int sendIP(int* arr, int ip_size,int filter){
	...
	shared_mem[PDATA] = (int) arr;
	shared_mem[PSIZE] = (int) ip_size;
	shared_mem[PFILT] = (int) filter;
	shared_mem[PRES1] = (int) &result_ip1;
	shared_mem[PRES2] = (int) &result_ip2;
	shared_mem[PRES3] = (int) &result_ip3;
	shared_mem[PRES4] = (int) &result_ip4;

	// Update Cash
	Xil_DCacheFlushRange((u32)arr, (N_POINTS)*sizeof(int));
	Xil_DCacheFlushRange((u32)vector, (N_POINTS)*sizeof(int));
	Xil_DCacheFlushRange((u32)&result_ip1, sizeof(int));
	Xil_DCacheFlushRange((u32)&result_ip2, sizeof(int));
	Xil_DCacheFlushRange((u32)&result_ip3, sizeof(int));
	Xil_DCacheFlushRange((u32)&result_ip4, sizeof(int));
	...
	Xil_DCacheInvalidateRange((u32) &result_ip1, sizeof(int));
	Xil_DCacheInvalidateRange((u32) &result_ip2, sizeof(int));
	Xil_DCacheInvalidateRange((u32) &result_ip3, sizeof(int));
	Xil_DCacheInvalidateRange((u32) &result_ip4, sizeof(int));

	result_ip = result_ip1 + result_ip2 + result_ip3 + result_ip4;
