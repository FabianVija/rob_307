...
HD_PWD='/home/lais/Documentos/ROB307/rob_307/Count/hw_ip_only/hw_ip_only.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count_ip_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count_ip_wrapper.tcl -notrace
