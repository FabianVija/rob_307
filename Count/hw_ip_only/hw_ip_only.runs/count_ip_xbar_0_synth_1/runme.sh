...
HD_PWD='/home/lais/Documentos/ROB307/rob_307/Count/hw_ip_only/hw_ip_only.runs/count_ip_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log count_ip_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source count_ip_xbar_0.tcl
