set C_TypeInfoList {{ 
"doKmean" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inStream": [[], {"reference": "0"}] }, {"outStream": [[], {"reference": "0"}] }, {"gain": [[], {"scalar": "int"}] }],[],""], 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.doKmean_CRTL_BUS_s_axi_U", "Parent" : "0"}]}
